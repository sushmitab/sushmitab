...
\indent {Graduate Research Assistant}\hfill sbhatt55@asu.edu\\
\indent {Arizona State University}
...
%\resheading{\textbf{\large Courses Taken}}
%\begin{description}
%\item \hspace{0.75 cm} Implementation Techniques for Relational Database Systems, Spatial Databases, Natural Language Processing, Embedded Systems, Network Security Cryptography II, Mobile Computing
%\end{description}
